...
- **Royal Paladin — MID-GAME** (aggiornato 11 set 2026). **Distance Fighting 74, Shielding 60, Magic Level 13.** (era lv40/D71/S57 il 2 set; lv30/D64/S53 il 27 lug.) ⚠️ **Livello esatto da riconfermare** (>40, si è auto-definito "mid-game paladin"; non assumere 40). Distance = skill primaria. ⚠️ Il default `CHAR_DEF` nella reverse map è fermo a D64/S53 (lug) → rigenerare/ripubblicare (skill `rivalia-map`).
