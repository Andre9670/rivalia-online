...
- **Livello 30** (aggiornato 27 lug 2026). **Distance Fighting 64, Shielding 53.** (era lv26 il 15 lug.) Distance = skill primaria in training. Queste stat sono il default `CHAR_DEF` nella reverse map.
